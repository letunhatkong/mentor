<div class="col-12 margin-top">
    <div class="row-fluid">
        <div class="row-observation row-content">
            <div class="col-12">
                <a class="col-6 img-avartar">
					<?php if ($dataActiveDetail['avatarPath'] != "" && $dataActiveDetail['avatarPath'] != null) {
						$avatar = Yii::app()->params['avatarFolderPath'] . '/' . $dataActiveDetail['avatarPath'];
					} else {
						$avatar = Yii::app()->params['avatarDefault'];
					} ?>
					<img src="<?php echo Yii::app()->getBaseUrl() . $avatar ?>" alt="">
						<span>
							<?php echo $dataActiveDetail['firstName'] ." ". $dataActiveDetail['lastName'] ?>
						</span>
                </a>

                <div class="col-6 countdown">
                    <div class="countdown-active" id="getTimeLifeOfSession"
                         data-time="<?php echo $dataActiveDetail['activatedPoint'] ?>">
                        <span>Active </span>
                        <span id="pastTimeDay">00</span>
                        <span>:</span>
                        <span id="pastTimeHour">00</span>
                        <span>:</span>
                        <span id="pastTimeMin">00</span>
                        <span>:</span>
                        <span id="pastTimeSec">00</span>
                    </div>
                </div>
            </div>
            <!-- Document -->
            <div class="col-12">
                <div class="col-nd-topic text-align-right">
                    <span class="txt-topic"><?php echo $dataActiveDetail['name'] ?></span>

                    <div class="row-fluid">
                        <?php if ((int)$dataActiveDetail['numArchive'] > 0) { ?>
                            <a class="btn-icon document-acitve">
                                <b><?php echo $dataActiveDetail['numArchive'] ?></b>
                                <span>Documents</span>
                            </a>
                        <?php } else { ?>
                ...
                <div class="col-nd-title">
                    <h1 class="txt-title"><?php echo CHtml::encode($dataActiveDetail['title']) ?></h1>

                    <p class="txt-mg"><?php echo CHtml::encode($dataActiveDetail['description']) ?></p>
                    <div class="dropdown">
            ...
            <div class="col-12 containerComment title-comment" id="containerComment<?php echo $dataActiveDetail['idSession']; ?>">
                <?php if (isset($dataComment)) { ?>
                    <?php foreach ($dataComment as $itemComment) {
                                        ...
                                        <div class="message-body">
                                            ...
                                            <div class="like-comment">
                                                <?php if ($dataSetting->allowComment == 1) { ?>
                                                    <a href="#commentText" data-backdrop="static" data-keyboard="false" data-toggle="modal" class="buttonCommentText"
                                            ...
                                            <div class="editDeleteCmtWrapper">
                                                <div class="editCmt">
                                                    <?php if ($itemComment['contentMediaType'] == "TEXT") { ?>
                                                        <a href="#commentText" data-toggle="modal" data-backdrop="static" data-keyboard="false" class="clickEditComment"
                                            ...
                                            <div class="sub-cmt" id="containerCommentReply<?php echo $itemComment['idComment'] ?>">
                                                <?php foreach ($dataComment as $itemReplyComment) { ?>
                                                    <?php if ($itemReplyComment['idCommentParent'] == $itemComment['idComment']) { ?>
                                                <div class="row-fluid" id="commentRow<?php echo $itemReplyComment['idComment'] ?>">
                                                    ...
                                                    <div class="messages-video">
                                                        <div class="msg-time-chat">
															...
															<a class="img-avartar">
                                                            <?php if ($itemReplyComment['avatarPath'] != "" && $itemReplyComment['avatarPath'] != null) {
...
<?php if ($dataSetting->allowComment == 1) { ?>
    ...
    <a role="button" class="btn-add btn-video-app display-none" id="uploadVideoMobile">
        <span><i class="fa fa-video-camera"></i></span>
    </a>
    ...
    <a role="button" class="btn-add btn-camera-app display-none" id="uploadPictureMobile">
        <span><i class="fa fa-camera"></i></span>
    </a>
    ...
    <div id="commentText" class="modal hide" tabindex="-1" role="dialog" aria-labelledby="commentTextLabel"
        ...
        <form id="commentTextForm">
            <input type="hidden" value="<?php echo $dataActiveDetail['idSession'] ?>" id="idSessionCommentText"
    ...
    <div id="myCamera" class="modal hide fade modal-video" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1"
         aria-hidden="true">
        <input type="hidden" value="<?php echo $dataActiveDetail['idSession'] ?>" name="idSessionCommentImage"
    ...
    <div id="myVideo" class="modal hide fade modal-video" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1"
        ...
        <input type="hidden" id="idSessionCommentVideo" name="idSessionCommentVideo"
               value="<?php echo (int)$dataActiveDetail['idSession']; ?>"/>
...
<script type="text/javascript">
    var idSession = <?php echo $dataActiveDetail['idSession']; ?>;
